...
public interface PersistentPhoneBook extends PhoneBook {
    ...
    Matcher LINE_RECOGNIZER = Pattern.compile(
    ...
    /**
     * Charge le contenu du fichier texte associé à cet annuaire.
     * Si le chargement est impossible, une BadSyntaxException est levée et
     *  l'annuaire est alors vide.
     * @pre
     *     getFile() != null
     * @post
     *     L'annuaire a été initialisé avec le contenu du fichier associé

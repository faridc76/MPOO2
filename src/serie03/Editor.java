...
public interface Editor {
     ...
     *     nbOfPossibleRedo() == 0
     *     La commande d'effacement que l'on vient d'exécuter
     *      est la première commande qui sera annulée par undo </pre>
     */
    void clear();
    /**
     ...
     *         min(old nbOfPossibleUndo() + 1, getHistorySize())
     *     nbOfPossibleRedo() == 0
     *     La commande d'insertion que l'on vient d'exécuter
     *      est la première commande qui sera annulée par undo </pre>
     */
     ...
     *         min(old nbOfPossibleUndo() + 1, getHistorySize())
     *     nbOfPossibleRedo() == 0
     *     La commande de suppression que l'on vient d'exécuter
     *      est la première commande qui sera annulée par undo </pre>
     */
